...
import orthoExtractorPackage.BingImgDownloader;
import orthoExtractorPackage.loadingBar;

/**
 * This thead allow you multiple download images from Bing Map.
 * @author Geoffrey
 */
public class ThreadBingImgExtract implements Runnable
{
	/**
	 ...
	 * The loading bar.
	 */
	public ThreadBingImgExtract(String PathForDownloadedGroundImg, BingImgDownloader SaveTiffOnDiscObj, loadingBar LoadBarObj)
	{
